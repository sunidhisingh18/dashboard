          ...
          Row {
            ...
            Rectangle{
                ...
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        console.log("callingsclick")
                        stackView.push("qrc:/Pages/Callings.qml",{stackView : stackView})
                    }
                }
            }
            Rectangle{
            ...
            Rectangle{
                ...
                MouseArea{
                    ...
                    onClicked: {
                        ...
                        stackView.push("qrc:/Pages/Music.qml",{stackView : stackView})
                    }
                }
            }
            Rectangle{
            ...
            Rectangle{
                ...
                MouseArea{
                    ...
                    onClicked: {
                        ...
                        stackView.push("qrc:/Pages/Profile.qml",{stackView : stackView})
                    }
                }
